...
<head>
    <meta charset="utf-8">
    <title>Tablets: S-Z Page HFPT1A</title>
...
<img src=".../PharmTechCustomization/HFPT1A/Pharmacy-Shelves-Tablets-S-Z.png" width="100%" class="map" usemap="#features" id="drugShelfImage">
...
if(isset($_GET['myData'])) {
    ...
    $_SESSION['savedDrugs']['s2zTabs'] = $_GET['myData'];

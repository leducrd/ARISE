...
<head>
    <meta charset="utf-8">
    <title>Liquids Page HFPT1A</title>
...
<img src="https://www.wisc-online.com/ARISE_Files/PharmTechCustomization/HFPT1A/Pharmacy-Shelves-Liquids.png" width="100%" class="map" usemap="#features" id="drugShelfImage">
...
if(isset($_GET['myData'])) {
    ...
    $_SESSION['savedDrugs']['liquids'] = $_GET['myData'];

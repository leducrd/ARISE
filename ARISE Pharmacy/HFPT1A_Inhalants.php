...
<head>
    <meta charset="utf-8">
    <title>Inhalants Page HFPT1A</title>
...
<img src=".../PharmTechCustomization/HFPT1A/Pharmacy--Shelves-Inhalents.png" width="100%" class="map" usemap="#features" id="drugShelfImage">
...
<script type="text/javascript" src=".../ARISE_Files/JS/fastClickJS.js"></script>
...
if(isset($_GET['myData'])) {
    ...
    $_SESSION['savedDrugs']['inhalants'] = $_GET['myData'];

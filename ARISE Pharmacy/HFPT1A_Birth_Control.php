...
<head>
    <meta charset="utf-8">
    <title>Birth Control Page HFPT1A</title>
...
<img src=".../PharmTechCustomization/HFPT1A/Contraceptives-Shelf.png" width="100%" class="map" usemap="#features" id="drugShelfImage">
...
if(isset($_GET['myData'])) {
    ...
    $_SESSION['savedDrugs']['birthControl'] = $_GET['myData'];
